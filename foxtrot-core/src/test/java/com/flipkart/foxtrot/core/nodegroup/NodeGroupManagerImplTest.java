...
public class NodeGroupManagerImplTest {
    ...
    public void shouldCreateNodeGroupWithCommonAllocation() throws IOException {
        ...
        Assert.assertNotNull(vacantGroup);
        SortedSet<String> vacantNodes = Sets.newTreeSet(
                Lists.newArrayList("elasticsearch400.test.com", "elasticsearch401.test.com",
                        "elasticsearch500.test.com", "elasticsearch501.test.com"));
        Assert.assertEquals(vacantNodes.size(), vacantGroup.getNodePatterns()
                .size());
    ...
    public void shouldGetNodeGroups() throws IOException {
        ...
        SortedSet<String> vacantNodes = Sets.newTreeSet(
                Lists.newArrayList("elasticsearch500.test.com", "elasticsearch501.test.com"));
    ...
    public void shouldGetNodeGroupDetails() throws IOException {
        ...
        ESNodeGroupDetailResponse androidGroupDetails = ESNodeGroupDetailResponse.builder()
                ...
                .details(ESNodeGroupDetails.builder()
                        .nodeCount(2)
                        .nodeInfo(new TreeMap<>(ImmutableMap.of("elasticsearch100.test.com", DiskUsageInfo.builder()
                                ...
                                "elasticsearch101.test.com", DiskUsageInfo.builder()
                                        .totalDiskStorage(
        ...
        ESNodeGroupDetailResponse paymentGroupDetails = ESNodeGroupDetailResponse.builder()
                ...
                .details(ESNodeGroupDetails.builder()
                        .nodeCount(2)
                        .nodeInfo(new TreeMap<>(ImmutableMap.of("elasticsearch200.test.com", DiskUsageInfo.builder()
                                        .totalDiskStorage(StorageSizeUtils.humanReadableByteCountSI((long) Math.pow(10, 9)))
                                        .availableDiskStorage(
                                                StorageSizeUtils.humanReadableByteCountSI((long) Math.pow(10, 9) / 2))
                                        .usedDiskStorage(StorageSizeUtils.humanReadableByteCountSI((long) Math.pow(10, 9) / 2))
                                ...
                                "elasticsearch201.test.com", DiskUsageInfo.builder()
                                        .totalDiskStorage(
                                                StorageSizeUtils.humanReadableByteCountSI((long) Math.pow(10, 9)))
                                        .availableDiskStorage(
                                                StorageSizeUtils.humanReadableByteCountSI((long) Math.pow(10, 9) / 2))
        ...
        ESNodeGroupDetailResponse allGroupDetails = ESNodeGroupDetailResponse.builder()
                ...
                .details(ESNodeGroupDetails.builder()
                        .nodeCount(4)
                        .nodeInfo(new TreeMap<>(ImmutableMap.of("elasticsearch300.test.com", DiskUsageInfo.builder()
                                        .totalDiskStorage(StorageSizeUtils.humanReadableByteCountSI((long) Math.pow(10, 9)))
                                        .availableDiskStorage(
                                                StorageSizeUtils.humanReadableByteCountSI((long) Math.pow(10, 9) / 2))
                                        .usedDiskStorage(StorageSizeUtils.humanReadableByteCountSI((long) Math.pow(10, 9) / 2))
                                ...
                                "elasticsearch301.test.com", DiskUsageInfo.builder()
                                        .totalDiskStorage(
                                                StorageSizeUtils.humanReadableByteCountSI((long) Math.pow(10, 9)))
                                        .availableDiskStorage(
                                                StorageSizeUtils.humanReadableByteCountSI((long) Math.pow(10, 9) / 2))
                                        .usedDiskStorage(
                                                StorageSizeUtils.humanReadableByteCountSI((long) Math.pow(10, 9) / 2))
                                        .usedDiskPercentage("50.00%")
                                        .build(), "elasticsearch400.test.com", DiskUsageInfo.builder()
                                        .totalDiskStorage(
                                                StorageSizeUtils.humanReadableByteCountSI((long) Math.pow(10, 9)))
                                        .availableDiskStorage(
                                                StorageSizeUtils.humanReadableByteCountSI((long) Math.pow(10, 9) / 2))
                                ...
                                "elasticsearch401.test.com", DiskUsageInfo.builder()
                                        .totalDiskStorage(
                                                StorageSizeUtils.humanReadableByteCountSI((long) Math.pow(10, 9)))
                                        .availableDiskStorage(
                                                StorageSizeUtils.humanReadableByteCountSI((long) Math.pow(10, 9) / 2))
        ...
        ESNodeGroupDetailResponse vacantGroupDetails = ESNodeGroupDetailResponse.builder()
                ...
                .details(ESNodeGroupDetails.builder()
                        .nodeCount(2)
                        .nodeInfo(new TreeMap<>(ImmutableMap.of("elasticsearch500.test.com", DiskUsageInfo.builder()
                                        .totalDiskStorage(StorageSizeUtils.humanReadableByteCountSI((long) Math.pow(10, 9)))
                                        .availableDiskStorage(
                                                StorageSizeUtils.humanReadableByteCountSI((long) Math.pow(10, 9) / 2))
                                        .usedDiskStorage(StorageSizeUtils.humanReadableByteCountSI((long) Math.pow(10, 9) / 2))
                                ...
                                "elasticsearch501.test.com", DiskUsageInfo.builder()
                                        .totalDiskStorage(
                                                StorageSizeUtils.humanReadableByteCountSI((long) Math.pow(10, 9)))
                                        .availableDiskStorage(
                                                StorageSizeUtils.humanReadableByteCountSI((long) Math.pow(10, 9) / 2))
    ...
    public void shouldDeleteNodeGroup() throws IOException {
        ...
        SortedSet<String> vacantNodes = Sets.newTreeSet(
                Lists.newArrayList("elasticsearch200.test.com", "elasticsearch201.test.com",
                        "elasticsearch300.test.com", "elasticsearch301.test.com", "elasticsearch400.test.com",
                        "elasticsearch401.test.com", "elasticsearch500.test.com",
